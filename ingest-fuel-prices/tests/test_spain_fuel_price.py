...
class TestFuelPrice(TestCase):
    ...
    def test_create_spain_fuel_dataframe(self):
        ...
        expected_data = [
            ("2024-10-09t20:12:15", "2024-10-09", "02250", "4375", "07", "52", "02", "p", "nº 10.935",
             "avenida castilla la mancha, 26", "abengibre", "albacete", "abengibre", "39,211417", "-1,539167", "", "",
             "", "", "", "1,299", "0,899", "", "", "1,399", "", "", "", "",
             ),
            ("2024-10-09t20:12:15", "2024-10-09", "02152", "5122", "07", "53", "02", "p", "repsol", "cr cm-332, 46,4",
             "alatoz", "albacete", "alatoz", "39,100389", "-1,346083", "", "", "", "", "", "1,589", "", "1,709", "",
             "1,699", "", "", "", "",
             ),
        ]
